...
슬럼프가 왔다. 공부를 할 수 없었다. 목표가 없던 그때로 돌아갔다. 상태는 심각해져만 갔다. 불면증에 시달렸고 학교에서는 졸기만 했다. 야간 자율학습 시간에는 잠을 깨기 위해서 서 있는데 소용없었다. 다리에 힘이 풀리고 계속 쓰러졌다. 너무 위험해서 그냥 앉아서 졸았다. 하루 16시간 이상을 잤다.
