...
그것을 들어주지 않으면 원망을하고 들어주면 다른 라인의 구성원이 반대를 한다.
...
편애, 더 좋게 봐주는 것 이런 불평등이 있어야 자신에게 붙는 사람이 생긴다.
...
이것이 지나치면 불만이 쌓이므로 적절한 균형이 중요하다.
...
권력은 가질수록 할 수 있는 것이 많아짐과 동시에 위험해진다.
